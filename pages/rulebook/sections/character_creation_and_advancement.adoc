...
Read about it in the <<_backgrounds>> section.
...
You can read what they do in the <<_skills>> section.
...
You can read what your assets and powers do in the <<_assets>> and <<_powers>> section.
